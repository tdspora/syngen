...
@pytest.mark.parametrize("wrong_setting, expected_error", [
    ({"source": 0}, "The details are - {'fk_test': {'infer_settings': {"
                    "'destination': ['Not a valid string.']}}}"),
    ({"epochs": 0}, "The details are - {'fk_test': {'train_settings': "
                    "{'epochs': ['Must be greater than or equal to 1.']}}}"),
    ({"epochs": "not a valid type of a value"}, "The details are - {'fk_test': {'train_settings': "
                                                "{'epochs': ['Not a valid integer.']}}}"),
    ({"drop_null": "not a valid type of a value"}, "The details are - {'fk_test': {'train_settings': {"
                                                   "'drop_null': ['Not a valid boolean.']}}}"),
    ({"row_limit": 0}, "The details are - {'fk_test': {'train_settings': "
                       "{'row_limit': ['Must be greater than or equal to 1.']}}}"),
    ({"row_limit": "not a valid type of a value"}, "The details are - {'fk_test': {'train_settings': "
                                                   "{'row_limit': ['Not a valid integer.']}}}"),
    ({"batch_size": 0}, "The details are - {'fk_test': {'train_settings': "
                        "{'batch_size': ['Must be greater than or equal to 1.']}}}"),
    ({"batch_size": "not a valid type of a value"}, "The details are - {'fk_test': {'train_settings': "
                                                    "{'batch_size': ['Not a valid integer.']}}}"),
    ({"print_report": "not a valid type of a value"}, "The details are - {'fk_test': {'train_settings': "
                                                      "{'print_report': ['Not a valid boolean.']}}}"),
    ({"column_types": {"invalid_category": ["column_1", "column_2"]}}, "The details are - {'fk_test': {"
...
@pytest.mark.parametrize("wrong_setting, expected_error", [
    ({"epochs": 0}, "The details are - {'global': {'train_settings': "
                    "{'epochs': ['Must be greater than or equal to 1.']}}}"),
    ({"epochs": "not a valid type of a value"}, "The details are - {'global': {'train_settings': "
                                                "{'epochs': ['Not a valid integer.']}}}"),
    ({"drop_null": "not a valid type of a value"}, "The details are - {'global': {'train_settings': {"
                                                   "'drop_null': ['Not a valid boolean.']}}}"),
    ({"row_limit": 0}, "The details are - {'global': {'train_settings': "
                       "{'row_limit': ['Must be greater than or equal to 1.']}}}"),
    ({"row_limit": "not a valid type of a value"}, "The details are - {'global': {'train_settings': "
                                                   "{'row_limit': ['Not a valid integer.']}}}"),
    ({"batch_size": 0}, "The details are - {'global': {'train_settings': "
                        "{'batch_size': ['Must be greater than or equal to 1.']}}}"),
...
@pytest.mark.parametrize("wrong_setting, expected_error", [
    ({"destination": 0}, "The details are - {'fk_test': {'infer_settings': {"
                         "'destination': ['Not a valid string.']}}}"),
    ({"size": 0}, "The details are - {'fk_test': {'infer_settings': {"
                  "'size': ['Must be greater than or equal to 1.']}}}"),
    ({"size": "not a valid type of a value"}, "The details are - {'fk_test': {'infer_settings': {"
                                              "'size': ['Not a valid integer.']}}}"),
    ({"run_parallel": "not a valid type of a value"}, "The details are - {'fk_test': {'infer_settings': {"
                                                      "'run_parallel': ['Not a valid boolean.']}}}"),
    ({"random_seed": -1}, "The details are - {'fk_test': {'infer_settings': {"
                          "'random_seed': ['Must be greater than or equal to 0.']}}}"),
    ({"random_seed": "not a valid type of a value"}, "The details are - {'fk_test': {'infer_settings': "
                                                     "{'random_seed': ['Not a valid integer.']}}}"),
    ({"print_report": "not a valid type of a value"}, "The details are - {'fk_test': {'infer_settings': {"
                                                      "'print_report': ['Not a valid boolean.']}}}")
])
...
@pytest.mark.parametrize("wrong_setting, expected_error", [
    ({"size": 0}, "The details are - {'global': {'infer_settings': {"
                  "'size': ['Must be greater than or equal to 1.']}}}"),
    ({"size": "not a valid type of a value"}, "The details are - {'global': {'infer_settings': {"
                                              "'size': ['Not a valid integer.']}}}"),
    ({"run_parallel": "not a valid type of a value"}, "The details are - {'global': {'infer_settings': {"
                                                      "'run_parallel': ['Not a valid boolean.']}}}"),
    ({"random_seed": -1}, "The details are - {'global': {'infer_settings': {"
                          "'random_seed': ['Must be greater than or equal to 0.']}}}"),
    ({"random_seed": "not a valid type of a value"}, "The details are - {'global': {'infer_settings': "
                                                     "{'random_seed': ['Not a valid integer.']}}}"),
    ({"print_report": "not a valid type of a value"}, "The details are - {'global': {'infer_settings': {"
                                                      "'print_report': ['Not a valid boolean.']}}}")
])
...
@pytest.mark.parametrize("wrong_setting, expected_error", [
    ...
    ({"quotechar": 0}, "The details are - {'fk_test': {'quotechar': ['Not a valid string.']}}"),
    ({"quotechar": "value with more than one character"}, "The details are - {'fk_test': {'quotechar': ["
                                                          "'Length must be 1.']}}"),
    ({"quoting": 0}, "The details are - {'fk_test': {'quoting': ['Not a valid string.']}}"),
    ({"quoting": "not a valid value"}, "The details are - {'fk_test': {'quoting': ["
                                       "'Must be one of: minimal, all, non-numeric, none.']}}"),
    ({"escapechar": 0}, "The details are - {'fk_test': {'escapechar': ['Not a valid string.']}}"),
    ({"escapechar": "value with more than one character"}, "The details are - {'fk_test': {'escapechar': ["
                                                           "'Length must be 1.']}}"),
    ({"encoding": 0}, "The details are - {'fk_test': {'encoding': ['Not a valid string.']}}"),
    ({"header": "not a valid type of a value"}, "The details are - {'fk_test': {"
                                                "'header': ['Invalid value.']}}"),
    ({"skiprows": "not a valid type of a value"}, "The details are - {'fk_test': {"
                                                  "'skiprows': ['Invalid value.']}}"),
    ({"on_bad_lines": 0}, "The details are - {'fk_test': {'on_bad_lines': ['Not a valid string.']}}"),
    ({"on_bad_lines": "not a valid value"}, "The details are - {'fk_test': {'on_bad_lines': ["
                                            "'Must be one of: error, warn, skip.']}}"),
    ({"engine": 0}, "The details are - {'fk_test': {'engine': ['Not a valid string.']}}"),
    ({"engine": "not a valid value"}, "The details are - {'fk_test': {'engine': ['Must be one of: c, python.']}}"),
...
@pytest.mark.parametrize("wrong_setting, expected_error", [
    ...
    ({"quotechar": '"'}, "The details are - {'pk_test': {'quotechar': ['Unknown field.']}}"),
    ({"quoting": "non-numeric"}, "The details are - {'pk_test': {'quoting': ['Unknown field.']}}"),
    ({"escapechar": "\\"}, "The details are - {'pk_test': {'escapechar': ['Unknown field.']}}"),
    ({"encoding": "ascii"}, "The details are - {'pk_test': {'encoding': ['Unknown field.']}}"),
    ({"header": 0}, "The details are - {'pk_test': {'header': ['Unknown field.']}}"),
    ({"skiprows": 0}, "The details are - {'pk_test': {'skiprows': ['Unknown field.']}}"),
    ({"on_bad_lines": "skip"}, "The details are - {'pk_test': {'on_bad_lines': ['Unknown field.']}}"),
