...
@pytest.mark.parametrize("date_string, date_format, expected_timezone", [
    ("2023-03-15T14:30:00+00:00", "%Y-%m-%dT%H:%M:%S%z", "+00:00"),
    ("2023-03-15T14:30:00-01:00", "%Y-%m-%dT%H:%M:%S%z", "-01:00"),
    ("2023-03-15T14:30:00 +0000", "%Y-%m-%dT%H:%M:%S %z", "+0000"),
    ("2023-03-15T14:30:00 -0100", "%Y-%m-%dT%H:%M:%S %z", "-0100"),
    ("2023-03-15 14:30:00+00:00", "%Y-%m-%d %H:%M:%S%z", "+00:00"),
    ("2023-03-15 14:30:00-01:00", "%Y-%m-%d %H:%M:%S%z", "-01:00"),
    ("2023-03-15 14:30:00 +0000", "%Y-%m-%d %H:%M:%S %z", "+0000"),
    ("2023-03-15 14:30:00 -0100", "%Y-%m-%d %H:%M:%S %z", "-0100"),
    ("2023-03-15-14:30:00+00:00", "%Y-%m-%d-%H:%M:%S%z", "+00:00"),
    ("2023-03-15-14:30:00-01:00", "%Y-%m-%d-%H:%M:%S%z", "-01:00"),
    ("2023-03-15-14:30:00 +0000", "%Y-%m-%d-%H:%M:%S %z", "+0000"),
    ("2023-03-15-14:30:00 -0100", "%Y-%m-%d-%H:%M:%S%z", "-0100"),
    ("2023-03-15T14:30:00.000000+00:00", "%Y-%m-%dT%H:%M:%S.%f%z", "+00:00"),
    ("2023-03-15T14:30:00.000000-01:00", "%Y-%m-%dT%H:%M:%S.%f%z", "-01:00"),
    ("2023-03-15T14:30:00.000000 +0000", "%Y-%m-%dT%H:%M:%S.%f %z", "+0000"),
    ("2023-03-15T14:30:00.000000 -0100", "%Y-%m-%dT%H:%M:%S.%f %z", "-0100"),
    ("2023-03-15 14:30:00.000000+00:00", "%Y-%m-%d %H:%M:%S.%f%z", "+00:00"),
    ("2023-03-15 14:30:00.000000-01:00", "%Y-%m-%d %H:%M:%S.%f%z", "-01:00"),
    ("2023-03-15 14:30:00.000000 +0000", "%Y-%m-%d %H:%M:%S.%f %z", "+0000"),
    ("2023-03-15 14:30:00.000000 -0100", "%Y-%m-%d %H:%M:%S.%f %z", "-0100"),
    ("2023-03-15-14:30:00.000000+00:00", "%Y-%m-%d-%H:%M:%S.%f%z", "+00:00"),
    ("2023-03-15-14:30:00.000000-01:00", "%Y-%m-%d-%H:%M:%S.%f%z", "-01:00"),
    ("2023-03-15-14:30:00.000000 +0000", "%Y-%m-%d-%H:%M:%S.%f %z", "+0000"),
    ("2023-03-15-14:30:00.000000 -0100", "%Y-%m-%d-%H:%M:%S.%f %z", "-0100"),
    ("2023-03-15T11:29:00Z", "%Y-%m-%dT%H:%M:%S%z", "Z"),
    ("2023-03-15 11:29:00 AM EDT", "%Y-%m-%d %I:%M:%S %p %z", "EDT"),
    ("2023-03-15 11:29:00 PST", "%Y-%m-%d %I:%M:%S %p %z", "PST")
])
def test_fetch_timezone_from_date_string_with_tz(
    rp_logger, date_string, date_format, expected_timezone
):
    rp_logger.info(
        "Test the method 'fetch_timezone' that retrieves the timezone from the date string "
        "containing timezone information"
    )
    assert fetch_timezone(date_string, date_format) == expected_timezone
    rp_logger.info(SUCCESSFUL_MESSAGE)


@pytest.mark.parametrize("date_string, date_format", [
    ("2023-03-15 14:30:00", "%Y-%m-%d %H:%M:%S"),
    ("2023-03-15 14:30:00.000000", "%Y-%m-%d %H:%M:%S.%f"),
    ("2023-03-15T14:30:00.000000", "%Y-%m-%dT%H:%M:%S.%f"),
    ("2023-03-15-14:30:00.000000", "%Y-%m-%d-%H:%M:%S.%f"),
    ("2020-01-03 09:00 AM", "%Y-%m-%d %I:%M %p"),
    ("15-03-2020", "%d-%m-%Y"),
    ("15-03-2020 14:30:00", "%d-%m-%Y %H:%M:%S"),
    ("15-03-2020T14:30:00", "%d-%m-%YT%H:%M:%S"),
    ("15-03-2020-14:30:00", "%d-%m-%Y-%H:%M:%S"),
    ("15-03-2020 14:30:00.000000", "%d-%m-%Y %H:%M:%S.%f"),
    ("15-03-2020T14:30:00.000000", "%d-%m-%YT%H:%M:%S.%f"),
    ("15-03-2020-14:30:00.000000", "%d-%m-%Y-%H:%M:%S.%f")
])
def test_fetch_timezone_from_date_string_without_tz(rp_logger, date_string, date_format):
    rp_logger.info(
        "Test the method 'fetch_timezone' that retrieves the timezone from the date string "
        "not containing timezone information"
    )
    assert np.isnan(fetch_timezone(date_string, date_format))
    rp_logger.info(SUCCESSFUL_MESSAGE)
